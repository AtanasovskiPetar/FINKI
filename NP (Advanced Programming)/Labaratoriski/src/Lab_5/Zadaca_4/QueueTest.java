...
class Node <T>{
    ...
    public void setNext(Node<T> succ) {
        this.succ = succ;
    }
}
class Queue <T>{
    LinkedList<Node<T>> queueList;
    public Queue() {
    ...
    void enqueue(T element){
        queueList.add(new Node<>(element,null));
    }
    T dequeue() throws EmptyQueueException {
        if (queueList.isEmpty()){
            throw new EmptyQueueException();
        }
        T tmp = queueList.getFirst().element;
    ...
    T peek() throws EmptyQueueException {
        ...
        return queueList.getFirst().element;
    }
    T inspect() throws EmptyQueueException {
        if (queueList.isEmpty()){
            throw new EmptyQueueException();
        }
        return queueList.getLast().element;
    }
    int count(){
