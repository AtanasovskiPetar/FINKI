...
class FlatAmountProvisionTransaction extends Transaction{
    ...
    public void setFlatProvision(String flatProvision) {
        this.flatProvision = flatProvision;
    }
    @Override
    double getProvision() {
...
class FlatPercentProvisionTransaction extends Transaction{
    ...
    @Override
    double getProvision() {
        return Double.parseDouble(String.format(("%.2f"),(Double.parseDouble(getAmount().substring(0,getAmount().length()-1))*centsPerDolar/100)));
    }
