package Kolokvium2.InorderSuccessor;
...
class BinarySearchTree<E extends Comparable<E>> {
    ...
    private void inOrderRecursive(BNode<E> node) {
        if(node==null){
            return;
        }
    ...
    public E getSuccessor(E x)  throws Exception{
        return getSuccessor(root, x);
    }
    public E getSuccessor(BNode<E> t, E x){
        if(t==null)
            return null;
        if(t.right!=null&&t.info.equals(x))
            return findMin(t.right).info;
        else if(t.left!=null&&findMax(t.left).info.equals(x))
            return t.info;
        E tmp1=getSuccessor(t.left,x);
        if(tmp1!=null)
            return tmp1;
        E tmp2=getSuccessor(t.right,x);
        if(tmp2!=null)
            return tmp2;
        return null;
    }
