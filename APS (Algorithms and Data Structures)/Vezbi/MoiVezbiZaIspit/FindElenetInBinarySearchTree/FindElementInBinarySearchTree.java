package MoiVezbiZaIspit.FindElenetInBinarySearchTree;

/*
Најди го бројот Задача 2 (0 / 0)
Дадено е едно бинарно пребарувачко дрво кое што содржи N (1≤N≤1,000) природни броеви и еден број P (1≤P≤N). Да се пронајде кој е P-тиот најмал број во дрвото.

Не е дозволено користење на дополнителни структури како низи.

Не смее да се менува структурата на јазлите и на дрвото.
...
class BinarySearchTree<E extends Comparable<E>> {
    ...
    public E getNumberAtPositionNonRecursive(int pos){
        BNode<E> node =root;
        int currPos=0;
...
public class FindElementInBinarySearchTree{
    ...
    static int getNumberAtPosition(BinarySearchTree<Integer> tree, int P) {
        ...
        int pos =  tree.getNumberAtPositionNonRecursive(P-1);
