...
def get_direction(current, new):
    ...
    if new == "Pomesti coveche gore":
        return directions[(directions.index(current) + 1) % 4]
    elif new == "Pomesti coveche dolu":
        return directions[(directions.index(current) - 1) % 4]
    elif new == "Pomesti coveche desno":
        return directions[(directions.index(current) - 1) % 4]
    elif new == "Pomesti coveche gore-desno":
        return directions[(directions.index(current) - 1) % 4]
    elif new == "Pomesti coveche dolu-desno":
        return directions[(directions.index(current) - 1) % 4]
    else:
        return current
...
class Football(Problem):
    ...
    def successor(self, state):
        successors = dict()
        man_directions = ["Pomesti coveche gore", "Pomesti coveche dolu", "Pomesti coveche desno", "Pomesti coveche gore-desno", "Pomesti coveche dolu-desno"]
        ball_directions = ["Turni topka gore", "Turni topka dolu", "Turni topka desno", "Turni topka gore-desno", "Turni topka dolu-desno"]
        for dir in man_directions:
            direction = get_direction(state[-1], dir)
