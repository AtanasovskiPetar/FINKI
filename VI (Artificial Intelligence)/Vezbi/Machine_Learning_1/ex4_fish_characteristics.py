...
if __name__ == '__main__':
    ...
    rf_classifier = RandomForestClassifier(n_estimators=num_trees, criterion=crit, random_state=0)
    ...
    print(rf_classifier.predict([entry])[0])
    print(rf_classifier.predict_proba([entry])[0])
